...
FILE_NAME = 'test/design/PlanningResult/planning_result_231010_AutomatedPathes_TightCake_V1.json'
...
def execute_robotic_free_movement(abb, task):
    ...
    for trajectory_point in trajectory:
        ...
        instruction = rrc.MoveToJoints(
            joint_values, [], print_speed, zone=rrc.Zone.Z0, feedback_level=1)
...
def print_process():
    ...
    # --- Set tool
    abb.send_and_wait(rrc.SetTool('BioPrintDefT901'))
